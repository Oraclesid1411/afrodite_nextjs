...
import { faCamera,faCheckDouble, faImage,faRepeat, faPlus, faTimes } from '@fortawesome/free-solid-svg-icons'
...
function CreateProduit() {
  ...
  const captureImage = () => {
    ...
    setImages([...images, image]);
     ...
     // Convertir l'image du canvas en un fichier blob
     canvas.toBlob((blob) => {
      const file = new File([blob], `photo_${Date.now()}.png`, { type: 'image/png' });
      setCapturedFiles((prevFiles) => [...prevFiles, file]);
    }, 'image/png');
  };
  const Addimgs = () => {
  ...
  for(let j= 0; j< capturedFiles.length; j++ ){
    var this_path = URL.createObjectURL(capturedFiles[j]);
  ...
  //  les fichiers
   files_list = Array.from(capturedFiles);
  
 

   for(let k = 0; k < files.length; k++){
    tab_files.push(files[k])
   }
 
    

   for(let n = 0; n < files_list.length; n++){
    tab_files.push(files_list[n])
   }
  ...
  for(let i= 0;i < files_list.length; i++ ){
    ...
    tab_file_upload.push(files_list[i])
  }
   ...
   setFile(tab_file_upload);
      ...
      if(images_gallery_boxshow === false){
  ...
  // genre
   var genre_value = null;
    ...
    if(category === "vêtement"){
      // vérifier si l'article est publiable ou non
      //  oui
      if((values?.prix != "") && (values?.qte != "" ) &&
      ( genre != null) && ( age != null) &&
               ...
               (
                <>
                 {record === 1 
                  ...
                  (
                    <>
                      <div className="form_box preview_fiche_produit">
                        <Header_banner  data_props ={{ 
                                  //   title: 'Publier un produit: vêtement',
                  ...
                  (
                    ...
                    <div className="form_box create_formulaire">
                    {StateUpdate === 0 ?
                 ...
                 <>
                   <div className="camera_view">
                      ...
                      <div className="button_list">
                           ...
                           <button className='mode_btn'  onClick={switchCamera}>
                              {/* mode: {isFrontCamera ? 'Back' : 'Front'}  */}
                            ...
                            <button className='shots_btn'  onClick={captureImage}>
                              {/* <FontAwesomeIcon icon={faCamera} /> */}
                                <FontAwesomeIcon size="sm" icon={faCamera} className='icon-trusted'/>
                                         
                            </button>

                            <button className='file_btn' onClick={handleaddImages}>
                            {/* <FontAwesomeIcon icon={faCheckDouble} /> */}
                                <FontAwesomeIcon size="sm" icon={faCheckDouble} className='icon-trusted'/>
                              ...
                              <div className="container">
                                        ...
                                        <div className="thumb-wrapper flex_center">
                                                ...
                                                <div className="" >
                                                    ...
                                                    <label onClick={Addimgs} className='input_label'>
