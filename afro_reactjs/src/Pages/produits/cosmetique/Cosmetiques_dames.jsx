      ...
      const fetchData = async () => {
        ...
        try {
          ...
          console.log('request send')
            ...
            const rep1 = await axios.get(`${apiUrl}/produits/parfums_dames`);
            const rep2 = await axios.get(`${apiUrl}/produits/cremes_dames`);
            const rep3 = await axios.get(`${apiUrl}/produits/lotions_dames`);
            const rep4 = await axios.get(`${apiUrl}/produits/laits_dames`);
       ...
       <div className="body-wrapper">
          ...
          <Genre_links 
            ...
            />
                 ...
                 <RowView 
                 category = {{num : "3"}}
                    product_list_a ={{ title: 'parfums' , data: tab_1 , link : '/parfumsdames' , defaultImg:image_a}} 
                    product_list_b ={{ title: 'crèmes' , data: tab_2, link : '/cremesdames', defaultImg:image_a}} 
                    product_list_c ={{ title: 'lotions' , data: tab_3, link : '/lotionsdames' , defaultImg:image_a}} 
                    product_list_d ={{ title: 'lait de beauté' , data: tab_4, link : '/laitsdames' , defaultImg:image_a}} 
                 />
...
export default Cosmetiques_dames
