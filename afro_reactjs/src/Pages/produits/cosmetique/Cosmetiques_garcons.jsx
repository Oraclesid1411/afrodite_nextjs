      ...
      const fetchData = async () => {
        ...
        try {
          ...
          console.log('request send')
            ...
            const rep1 = await axios.get(`${apiUrl}/produits/parfums_garcon`);
            const rep2 = await axios.get(`${apiUrl}/produits/cremes_garcon`);
            const rep3 = await axios.get(`${apiUrl}/produits/lotions_garcon`);
            const rep4 = await axios.get(`${apiUrl}/produits/laits_garcon`);
       ...
       <div className="body-wrapper">
          ...
          <Genre_links 
               listdata ={{ 
                             ...
                             link_a: '/cosmetiquesdames'  , title_a : 'dames' ,active_a : 'actif',
                             link_b: '/cosmetiquesfilles'  , title_b : 'filles' ,active_b : 'nonactif',
                             link_c: '/cosmetiqueshommes'  , title_c : 'hommes' ,active_c : 'nonactif',
                             link_d: ''  , title_d : 'garçons', active_d : 'nonactif',
                          }} 
            />

                 <RowView 
                 category = {{num : "3"}}
                    product_list_a ={{ title: 'parfums' , data: tab_1 , link : '/parfumsgarcons' , defaultImg:image_a}} 
                    product_list_b ={{ title: 'crèmes' , data: tab_2, link : '/cremesgarcons', defaultImg:image_a}} 
                    product_list_c ={{ title: 'lotions' , data: tab_3, link : '/lotionsgarcons' , defaultImg:image_a}} 
                    product_list_d ={{ title: 'lait de beauté' , data: tab_4, link : '/laitsgarcons' , defaultImg:image_a}} 
                 />
...
export default Cosmetiques_garcons
