  ...
  useEffect(() => {
      ...
      const fetchData = async () => {
        ...
        try {
            ...
            const rep1 = await axios.get(`${apiUrl}/produits/parfums_homme`);
            const rep2 = await axios.get(`${apiUrl}/produits/cremes_homme`);
            const rep3 = await axios.get(`${apiUrl}/produits/lotions_homme`);
            const rep4 = await axios.get(`${apiUrl}/produits/laits_homme`);

            const rep5 = await axios.get(`${apiUrl}/produits/getParfum_uniAdulte`);
            const rep6 = await axios.get(`${apiUrl}/produits/getCreme_uniAdulte`);
            const rep7 = await axios.get(`${apiUrl}/produits/getLotion_uniAdulte`);
            const rep8 = await axios.get(`${apiUrl}/produits/getLait_uniAdulte`);
       ...
       <div className="body-wrapper">
          ...
          <Genre_links 
               listdata ={{ 
                             ...
                             link_b: '/cosmetiquesfilles'  , title_b : 'filles' ,active_b : 'nonactif',
                             link_c: ''  , title_c : 'hommes' ,active_c : 'actif',
            ...
            />
                 ...
                 <RowView 
                  category = {{num : "3"}}
                    product_list_a ={{ title: 'parfums' , data: tab_1 , link : '/parfumshommes' , defaultImg:image_a}} 
                    product_list_b ={{ title: 'crèmes' , data: tab_2, link : '/cremeshommes', defaultImg:image_a}} 
                    product_list_c ={{ title: 'lotions' , data: tab_3, link : '/lotionshommes' , defaultImg:image_a}} 
                    product_list_d ={{ title: 'lait de beauté' , data: tab_4, link : '/laitshommes' , defaultImg:image_a}} 
                 />
...
export default Cosmetiques_hommes
