      ...
      const fetchData = async () => {
        ...
        try {
          ...
          console.log('request send')
            ...
            const rep1 = await axios.get(`${apiUrl}/produits/haut_homme`);
            const rep2 = await axios.get(`${apiUrl}/produits/bas_homme`);
            const rep3 = await axios.get(`${apiUrl}/produits/combis_homme`);
            const rep4 = await axios.get(`${apiUrl}/produits/lingerie_homme`);
    ...
    <>
       ...
       <div className="body-wrapper">
          ...
          <Genre_links 
            ...
            />   
          <RowView 
                    product_list_a ={{ title: 'hauts' , data: liste_haut , link : '/hauthommes' , defaultImg:image_a}} 
                    product_list_b ={{ title: 'bas' , data: liste_bas, link : '/bashommes', defaultImg:image_a}} 
                    product_list_c ={{ title: 'combis' , data: liste_combis, link : '/combishommes' , defaultImg:image_a}} 
                    product_list_d ={{ title: 'lingeries' , data: liste_lingerie, link : '/lingeriehommes' , defaultImg:image_a}} 
                    category = {{num : "1"}}
                 />
...
export default Vetements_hommes
