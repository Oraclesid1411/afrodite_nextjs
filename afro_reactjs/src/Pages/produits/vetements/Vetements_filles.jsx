  ...
  useEffect(() => {
      ...
      const fetchData = async () => {
        ...
        try {
            ...
            const rep1 = await axios.get(`${apiUrl}/produits/haut_fille`);
            const rep2 = await axios.get(`${apiUrl}/produits/bas_fille`);
            const rep3 = await axios.get(`${apiUrl}/produits/combis_fille`);
            const rep4 = await axios.get(`${apiUrl}/produits/lingerie_fille`);
  ...
  return (
    <>
       ...
       <div className="body-wrapper">
          ...
          <RowView 
                  category = {{num : "1"}}
                    product_list_a ={{ title: 'hauts' , data: liste_haut , link : '/hautfilles' , defaultImg:image_a}} 
                    product_list_b ={{ title: 'bas' , data: liste_bas, link : '/basfilles', defaultImg:image_a}} 
                    product_list_c ={{ title: 'combis' , data: liste_combis, link : '/combisfilles' , defaultImg:image_a}} 
                    product_list_d ={{ title: 'lingeries' , data: liste_lingerie, link : '/lingeriefilles' , defaultImg:image_a}} 
                 />
...
export default Vetements_filles
