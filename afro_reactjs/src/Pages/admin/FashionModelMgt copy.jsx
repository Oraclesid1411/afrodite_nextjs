...
const groupedResults = mannequins_data.reduce((acc, row) => {
  ...
  if (!mannequin) {
    ...
    mannequin = { id_mannequin: row.idmannequin, paths: {} };
    acc.push(mannequin);
  }
...
console.log(groupedResults);
  ...
  const filteredModels = fashion_models.filter((model) =>
      ...
      <table className="models-table">
        ...
        <tbody>
          {paginatedModels.map((model) => (
            <tr key={model.idmannequin}>
              <td>{model.idmannequin}</td>
              <td>
                <input type="checkbox" />
              </td>
              <td>
              ...
              <td>
                ...
                <Link title="Voir"  to={`/admin/detail_mannequin/1/${model?.idmannequin}`}>
                  <FaEye />
                </Link>
                <button title="Supprimer" onClick={() => handleDelete(model.idmannequin)}>
                  <FaTrash />
                </button>
              </td>
            </tr>
            ...
            (
              ...
              <form onSubmit={handleSubmit} className="over_scroll">
                      ...
                      <div style={styles.formGroup}>
                        ...
                        placeholder="nom du mannequin" style={styles.input} />
                      </div>
                      <div style={styles.formGroup}>
                        <label>prenom :</label>
                        <input type="text"
                        ...
                        placeholder="prénom du mannequin" style={styles.input} />
                      </div>
                      <div style={styles.formGroup}>
                        <label>pseudo :</label>
                        <input type="text"
                        ...
                        placeholder="pseudo du mannequin" style={styles.input} />
                      </div>
                      <div style={styles.formGroup}>
