...
const Influenceurs_Mgt = () => {
  ...
  const [influenceurs_data , setinfluenceurs_data] = useState([]);
  const [podiums , setPodiums] = useState([]);
  const [details , setDetails] = useState([]);
  const [newuserdata , setnewuserdata] = useState([]);
  
  console.log("influenceurs_data")
  console.log(influenceurs_data)
        ...
        useEffect(() => {
          const fetchData = async () => {
            try {
              ...
              setinfluenceurs_data(rep1.data);
...
const groupedResults = influenceurs_data.reduce((acc, row) => {
      ...
      {isModalOpen && (
        <div style={styles.modalOverlay}>
          ...
          <button onClick={closeModal} style={styles.closeButton}>
            ...
            <h2 style={{fontSize : "18px" , textAlign : "center"}}>nouvelle influenceuse</h2>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <div style={{ marginTop: "10px", padding: "10px", border: "1px solid #ccc", borderRadius: "8px" }}>
                      ...
                      <span className='title_label'>
                          influenceur ajouté avec succès.
...
export default Influenceurs_Mgt;
