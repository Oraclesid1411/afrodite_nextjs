...
fetchData(userid);
  ...
  const handleSubmit = async (e) => {
    ...
    const videos_save = await next_optionVideo();
  ...
  // return false;
    ...
    const param = {imgs_save, videos_save, data_postulant, data_role ,data_fashion , data_host , userid }
...
// fin de traitements des images 
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='candidature_form' style={{ maxWidth: "600px", margin: "auto" }}>
       {/* Accordion for Model */}
