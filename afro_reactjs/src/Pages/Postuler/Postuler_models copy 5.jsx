...
// return false;
  ...
  onChange={() => handleCheckboxChange_b("mannequin", category)}
/>
...
/>
      ...
      <div className="flex items-center cursor-pointer" >
          ...
          />
        <FaWhatsapp size={24} className="text-green-500 ml-2" />
      </div>
      ...
      >
       <input
          ...
          />
            <FaTelegram size={24} className="text-blue-500 ml-2" />
      </div>
    </div>

        <div>

        <Select.Root value={extraOption} onValueChange={setExtraOption}>
      <Select.Trigger className="flex items-center px-4 py-2 border rounded-lg w-40 justify-between cursor-pointer">
        {extraOption === "Signal" ? (
