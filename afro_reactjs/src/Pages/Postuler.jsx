...
function Postuler() {
  ...
  const [ecosmoney, setecosmoney] = useState(null);
                      ...
                      <div style={{ border: '1px solid #ccc', marginBottom: '10px' }}>
                              ...
                              <div className="section-header ">
                                <div className="text-center">
                                    <h2 className="text-center">Dévenir Mannequin</h2>
                                </div>
                              </div>
                 ...
                 <div className="container mt-3">
                    ...
                    <div className="row">
                      <div style={{ border: '1px solid #ccc', marginBottom: '10px' }}>
                          ...
                          <div className="section-header">
                          <h6 className="mt-3 text-center">Dévenir aussi hotesse</h6>
                        </div>
