    ...
    <>
      ...
      <div className="form_bg bg-white franchise_ihm">
        ...
        <form autoComplete='off' className='candidature_form'>
          ...
          <div className="input_group first_zone">
            <div className="lbl_title w-100">votre franchise:</div>
            ...
            <div className="line_data_a">
               <div className="inputs_container_a">
                ...
                <input 
                    className="input_padding"
                    type="text"
                    placeholder="Capital d'investissement estimé"
                    value={formData.business.capital}
                    onChange={(e) => handleInputChange("business", "capital", e.target.value)}
                  />
            ...
            <div className="line_data_a">
               ...
               className='textarea'
               placeholder="Pourquoi souhaitez-vous ouvrir une franchise ?" 
               required
               value={formData.business.motivation}
               onChange={(e) => handleInputChange("business", "motivation", e.target.value)}
      ...
      />
          ...
          {/* Services Section */}
          <div className="mb-3 input_group snd_zone hide">
