...
function Mescomptes() {
  ...
  const [fs_seller, setFs_seller] = useState(null); 
  ...
  const [values, setValues] = useState({
    ...
    pseudo_admindepot: "",
    num_cdi_admindepot: "", 
    pays_admindepot: null,
    ville_admindepot: null,
    quartier_admindepot: null,
  ...
  const [Tab_pays, setTab_pays] = useState([]); 
  const [Tab_villes, setTab_villes] = useState([]); 
  const [Tab_quartiers, setTab_quartiers] = useState([]); 
  
  useEffect(() => {
  
    axios.get(`${apiUrl}/locations/getPays`)
      .then(response => {
        setTab_pays(response.data);
      })
      .catch(error => console.error('echec de récupération de la liste des pays', error));
  }, []);
  ...
  useEffect(() => {
    ...
    axios.get(`${apiUrl}/locations/getAllVilles`)
      .then(response => {
        setTab_villes(response.data);
      })
      .catch(error => console.error('echec de récupération de la liste des villes', error));
  }, []);

  
  useEffect(() => {
  
    axios.get(`${apiUrl}/locations/getAllQuartiers`)
      .then(response => {
        setTab_quartiers(response.data);
      })
      .catch(error => console.error('echec de récupération de la liste des quartiers', error));
  }, []);
...
// forms default values
  ...
  const setVendeur_default_values = () => {

    console.log(info_vendeur)
    // vendeur pro
    if(info_vendeur != null || info_vendeur != undefined){
      
    if(info_vendeur.type_vendeur === 1){
      console.log(fs_seller)
      setFs_seller("pro")
       // phone number
     let this_number = info_vendeur?.telvendeur;
     let this_indicatif = info_vendeur?.indicatif1;
     ...
     const this_fullnumber = this_indicatif + "" + this_number
     setPhone_pro(this_fullnumber)

        setValues({ ...values, 
              
              
          nom_pro: info_vendeur?.nomvendeur,
          prenom_pro: info_vendeur?.prenomvendeur,
          pseudo_pro: info_vendeur?.nom_prof_vendeur,
          num_cdi_pro: info_vendeur?.numcarte, 
          indication_pro: info_vendeur?.adrvendeur,
      })
    }
    else{
      
      setFs_seller("occasionnel") 
       // phone number
     let this_number = info_vendeur?.telvendeur;
     let this_indicatif = info_vendeur?.indicatif1;
     
   
      code_type = this_indicatif.startsWith("+")
     if(code_type === false){
      this_indicatif = "+" + this_indicatif;
     }

     const this_fullnumber = this_indicatif + "" + this_number
     setPhone_oc(this_fullnumber)

        setValues({ ...values, 
              
          nom_oc : values.nomvendeur,
          prenom_oc : values.prenomvendeur,
          pseudo_oc : values.nom_prof_vendeur,
          num_cdi : values.numcarte,
      })
    }
...
const handleSubmit = async (e) => {
  ...
  // update acheteur
    ...
    // locations acheteur 
    const pays_data = document.querySelector("select[name='pays_acheteur']" ).value;

    console.log(pays_data)
    
    const ville_data = document.querySelector("select[name='ville_acheteur']" ).value;

    console.log(ville_data)
    
    const quartier_data = document.querySelector("select[name='quartier_acheteur']" ).value;

    console.log(quartier_data) 
    ...
    pays : parseInt(pays_data),
    ville : parseInt(ville_data),
    quartier : parseInt(quartier_data),
  ...
  // pro
    ...
    console.log(form_type)
      ...
      if(fs_seller === "pro"){
        ...
        // tel vendeur pro
        var num_vendeurpro = document.querySelector(".react-international-phone-input[name='phone_pro']" );
        // console.log(num_vendeurpro)
        var split_vendpronumber = [];
        if(num_vendeurpro != null){
            // console.log('exist')
            const vendpro_phone_number = num_vendeurpro.value;
            // console.log(vendpro_phone_number);
            split_vendpronumber = vendpro_phone_number.split(" ");
            // const vendpro_contact = { indicatif: split_vendpronumber[0], tel: split_vendpronumber[1] };
            // console.log(vendpro_contact);
          }
        //  console.log('professionnel')
        // locations acheteur 
    const pays_data = document.querySelector("select[name='pays_vendeur']" ).value;
    const ville_data = document.querySelector("select[name='ville_vendeur']" ).value;
         const quartier_data = document.querySelector("select[name='quartier_vendeur']" ).value;
 
         vendeur_values = {
            vendeur_type : 'pro',
            userid : userid,
            nom : values.nom_pro,
            prenom : values.prenom_pro,
            pseudo : values.pseudo_pro,
            pays : parseInt(pays_data),
            ville : parseInt(ville_data),
            quartier : parseInt(quartier_data),
            indication : values.indication_pro,
            cni : values.num_cdi_pro,
            indicatif : split_vendpronumber[0],
            number : split_vendpronumber[1],
          
         };

       }
     else if(fs_seller === "occasionnel"){

       var split_vendoccnumber = [];
        var num_vendeurocc= document.querySelector(".react-international-phone-input[name='phone_occ']" );
        if(num_vendeurocc != null){
          // console.log('exist')
          const occvend_phone_number = num_vendeurocc.value;
          // console.log(occvend_phone_number);
          split_vendoccnumber = occvend_phone_number.split(" ");
          // const vendocc_contact = { indicatif: split_vendoccnumber[0], tel: split_vendoccnumber[1] };
          // console.log(vendocc_contact);

        
        }
      //  console.log('occasionnel')
        vendeur_values = {
          vendeur_type : 'occasionnel',
          userid : userid,
          nom : values.nom_oc,
          prenom : values.prenom_oc,
          pseudo : values.pseudo_oc,
          cni : values.num_cdi,
          indicatif : split_vendoccnumber[0],
          number : split_vendoccnumber[1],
          // pays : "",
          // ville : "",
          // quartier : "",
          // indication : "",
...
try {
console.log('vendeur update')
console.log(vendeur_values)
await axios
.post(`${apiUrl}/auth/update_vendeuroc`,
          [
...
// setError(err.response.data);
  ...
  // update artisan
    ...
    const pays_data = document.querySelector("select[name='pays_artisan']" ).value;
    const ville_data = document.querySelector("select[name='ville_artisan']" ).value;
         const quartier_data = document.querySelector("select[name='quartier_artisan']" ).value;
  ...
  // update admin depot
    ...
    const pays_data = document.querySelector("select[name='pays_admindepot']" ).value;
    const ville_data = document.querySelector("select[name='ville_admindepot']" ).value;
         const quartier_data = document.querySelector("select[name='quartier_admindepot']" ).value;
  ...
  // update livreur
    ...
    const pays_data = document.querySelector("select[name='pays_livreur']" ).value;
    const ville_data = document.querySelector("select[name='ville_livreur']" ).value;
         const quartier_data = document.querySelector("select[name='quartier_livreur']" ).value;
                                                          ...
                                                          <>
                                                           ...
                                                           <div className="item_list col-12">
                                                                  ...
                                                                  <div className="item_list col-12">
                                                                    ...
                                                                    <Locations 
                                                                        inputdata ={{ 
                                                                          pays_name : 'pays_acheteur',
                                                                          ville_name: 'ville_acheteur',
                                                                          quartier_name: 'quartier_acheteur'
                                                                          }} 
                                                             ...
                                                             <>
                                                              ...
                                                              (
                                                                <>
                                                                 ...
                                                                 <>
                                                                  {data.id === info_acheteur?.pays &&
                                                                    (
                                                                      <p className="subtotal-value">{data?.nom}</p>
                                                                    )
                                                            ...
                                                            (
                                                              ...
                                                              (
                                                                <>
                                                                 ...
                                                                 <>
                                                                  {data.idville === info_acheteur?.ville &&
                                                                    (
                                                                      <p className="subtotal-value">{data?.nomville}</p>
                                                                    )
                                                      ...
                                                      <div className="item_list">
                                                          ...
                                                          {info_acheteur?.quartier  === null || info_acheteur?.quartier === "" || info_acheteur?.quartier  === undefined? 
                                                            ...
                                                            (
                                                              ...
                                                              {Tab_quartiers.length > 0 &&
                                                              (
                                                                <>
                                                                  {Tab_quartiers.map(data => (

                                                                 <>
                                                                  {data.idquart  === info_acheteur?.quartier &&
                                                                    (
                                                                      <p className="subtotal-value">{data?.nomquartier}</p>
                                                                    )
                                                          ...
                                                          {vendeur_data && (
                                                            <>
                                                            {
                                                              ...
                                                              <>
                                                              {
                                                                  ...
                                                                  (
                                                                    ...
                                                                    <>
                                                                          <div className=" col-12">
                                                                            ...
                                                                            <label className="label d-block">Type vendeur: </label>
                                                                            </div>

                                                                        
                                                                          <div className=' box-block form-control form-control-lg'>
                                                                                ...
                                                                                <div className="React__checkbox">
                                                                                  <label>
                                                                                    <input
                                                                                      ...
                                                                                      name="vendeur_occasionnel"

                                                                                      checked={fs_seller === "occasionnel"}
                                                                                      onChange={handleVendeurChange}
                                                                                    />
                                                                                    <span className="React__checkbox--span" /> occasionnel
                                                                                  </label>
                                                                                </div>
                                                                              </div>
                                                                                ...
                                                                                <div className="React__checkbox">
                                                                                  <label>
                                                                                    <input
                                                                                      ...
                                                                                      className="React__checkbox--input"
                                                                                      name="vendeur_pro"
                                                                                      checked={fs_seller === "pro"}
                                                                                      onChange={handleVendeurChange}
                                                                                    />
                                                                                    <span className="React__checkbox--span" /> professionnel
                                                                                  </label>
                                                                                </div>
                                                                              </div>
                                                                ...
                                                                {fs_seller === "pro" ?
                                                                (
                                                                  // "formulaire vendeur professionnel"
                                                                     <>
                                                                        <div className="row ">
                                                                          <div className="item_list col-12">
                                                                            <fieldset>
                                                                          ...
                                                                          <Locations 
                                                                            inputdata ={{ 
                                                                              pays_name : 'pays_vendeur',
                                                                              ville_name: 'ville_vendeur',
                                                                              quartier_name: 'quartier_vendeur'
                                                                              }} 
                                                                ...
                                                                (
                                                                  ...
                                                                  ( 
                                                                      ...
                                                                      <div className="item_list">
                                                                          <h4 className="subtotal-title">Type vendeur</h4>
                                                                          {info_vendeur?.type_vendeur === null || info_vendeur?.type_vendeur === "" || info_vendeur?.type_vendeur === undefined ? 
                                                                            (
                                                                                <p className="subtotal-value"> - </p>
                                                                            )
                                                                            ...
                                                                            (
                                                                              <p className="subtotal-value">occasionnel</p>
                                                                 ...
                                                                 ( 
                                                                         <>
                                                                                   ...
                                                                                   (
                                                                                    ...
                                                                                    (
                                                                                      <>
                                                                                       ...
                                                                                       <>
                                                                                        {data.idville === info_vendeur?.ville &&
                                                                                          (
                                                                                            <p className="subtotal-value">{data?.nomville}</p>
                                                                                          )
                                                                                   ...
                                                                                   (
                                                                                    ...
                                                                                    (
                                                                                      <>
                                                                                       ...
                                                                                       <>
                                                                                        {data.idquart  === info_vendeur?.quartier &&
                                                                                          (
                                                                                            <p className="subtotal-value">{data?.nomquartier}</p>
                                                                                          )
                                                                          ...
                                                                          {info_vendeur?.type_vendeur === null || info_vendeur?.type_vendeur === "" || info_vendeur?.type_vendeur === undefined ? 
                                                                            ...
                                                                            (
                                                                              <p className="subtotal-value">professionnel</p>
                                                              ...
                                                              (
                                                                ...
                                                                <>
                                                                      <div className="row ">
                                                                        ...
                                                                        <Locations 
                                                                            inputdata ={{ 
                                                                              pays_name : 'pays_artisan',
                                                                              ville_name: 'ville_artisan',
                                                                              quartier_name: 'quartier_artisan'
                                                                              }} 
                                                                                    ...
                                                                                    (
                                                                                      ...
                                                                                      (
                                                                                        <>
                                                                                         ...
                                                                                         <>
                                                                                          {data.idville === info_artisan?.ville &&
                                                                                            (
                                                                                              <p className="subtotal-value">{data?.nomville}</p>
                                                                                            )
                                                                                    ...
                                                                                    (
                                                                                      ...
                                                                                      (
                                                                                        <>
                                                                                         ...
                                                                                         <>
                                                                                          {data.idquart  === info_artisan?.quartier &&
                                                                                            (
                                                                                              <p className="subtotal-value">{data?.nomquartier}</p>
                                                                                            )
                                                           ...
                                                           (
                                                             ...
                                                             <>
                                                                  ...
                                                                  <div className="item_list col-12">
                                                                      ...
                                                                      <Locations 
                                                                            inputdata ={{ 
                                                                              pays_name : 'pays_admindepot',
                                                                              ville_name: 'ville_admindepot',
                                                                              quartier_name: 'quartier_admindepot'
                                                                              }} 
                                                                ...
                                                                (
                                                                  ...
                                                                  (
                                                                    <>
                                                                     ...
                                                                     <>
                                                                      {data.idville === info_admindepot?.ville &&
                                                                        (
                                                                          <p className="subtotal-value">{data?.nomville}</p>
                                                                        )
                                                          ...
                                                          <div className="item_list">
                                                              ...
                                                              (
                                                                <>
                                                                 ...
                                                                 <>
                                                                  {data.idquart  === info_admindepot?.quartier &&
                                                                    (
                                                                      <p className="subtotal-value">{data?.nomquartier}</p>
                                                                    )
                                                           ...
                                                           (
                                                             ...
                                                             <>
                                                                   ...
                                                                   <div className="item_list col-12">
                                                                     ...
                                                                     <Locations 
                                                                            inputdata ={{ 
                                                                              pays_name : 'pays_livreur',
                                                                              ville_name: 'ville_livreur',
                                                                              quartier_name: 'quartier_livreur'
                                                                              }} 
                                                                       ...
                                                                       (
                                                                        ...
                                                                        (
                                                                          <>
                                                                           ...
                                                                           <>
                                                                            {data.idville === info_livreur?.ville &&
                                                                              (
                                                                                <p className="subtotal-value">{data?.nomville}</p>
                                                                              )
                                                                       ...
                                                                       (
                                                                        ...
                                                                        (
                                                                          <>
                                                                           ...
                                                                           <>
                                                                            {data.idquart  === info_livreur?.quartier &&
                                                                              (
                                                                                <p className="subtotal-value">{data?.nomquartier}</p>
                                                                              )
                                                                  ...
                                                                  (
                                                                      <>
                                                                          ...
                                                                          <div className="item_list">
                                                                            ...
                                                                            {info_em?.nom_proprietaire === null || info_em?.nom_proprietaire === "" || info_em?.nom_proprietaire === undefined ? 
                                                                              (
                                                                                  <p className="subtotal-value"> - </p>
                                                                              )
                                                                        ...
                                                                        <div className="item_list">
                                                                            <h4 className="subtotal-title">Prénom</h4>
                                                                            {info_em?.prenom_proprietaire === null || info_em?.prenom_proprietaire === "" || info_em?.prenom_proprietaire === undefined ? 
                                                                              (
                                                                                  <p className="subtotal-value"> - </p>
                                                                              )
                                                                        ...
                                                                        <div className="item_list">
                                                                            ...
                                                                            {info_em?.tel_proprietaire === null || info_em?.tel_proprietaire === "" || info_em?.tel_proprietaire === undefined ? 
                                                                              (
                                                                                  <p className="subtotal-value"> - </p>
                                                                              )
                                                                        ...
                                                                        <div className="item_list">
                                                                            <h4 className="subtotal-title">Mot de passe</h4>
                                                                            {info_em?.password === null  || info_em?.password === ""  || info_em?.password === undefined ? 
                                                                              (
                                                                                  <p className="subtotal-value"> - </p>
                                                                              )
