...
function Mescomptes() {
  ...
  const set_default_values = () => {
   // phone number
    ...
    setValues({ ...values, pseudo: user_info?.name , password: ""})
  ...
  const setAcheteur_default_values = () => {
    // phone number
     let this_number = info_acheteur?.tel_proprietaire;
      ...
      await axios
        ...
        .then((result) => {
          ...
          if(result?.data != undefined){
            ...
            const password_state = result?.data?.pass_change;
          ...
          setShowmsg(true)
              if(password_state === false){
                // mot de passe non modifier
                console.log("hide update box")
                // setUserdataUpdate(!user_data_upd);
  ...
  return (
    ...
    <Header_banner  data_props ={{ 
     ...
     {show_msg && (
            ...
            <>
                    <Alert variant="danger" onClose={() => setShowmsg(false)} dismissible>
                             ...
                             {/* compte vendeur */}
                                        <div className="col-lg-6 col-md-6 col-12">
                                            <div className="faq-item rounded">
                                                ...
                                                <form onSubmit={handleSubmit}  data-form ="vendeur">
                                                              ...
                                                              ( 
                                                                    ...
                                                                    <div className="item_list">
                                                                        ...
                                                                        {info_livreur?.tel_livreur === null || info_livreur?.tel_livreur === "" || info_livreur?.tel_livreur === undefined ? 
                                                                          ...
                                                                          (
                                                                            <p className="subtotal-value">{`${info_livreur?.indicatif_livreur}`} {info_artisan?.tel_livreur}</p>
                                                ...
                                                <form onSubmit={handleSubmit}  data-form ="em">
                                                  ...
                                                  <>
                                                  {
                                                      em_data_upd 
                                                        ...
                                                        ( 
                                                        <button className='edit_btn' onClick={setEmDataupd}>
                                                          modifier
                                                        </button>
                                                        )
