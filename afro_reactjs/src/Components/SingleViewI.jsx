...
<div className="col-12 col-lg-3 col-md-3 col-sm-12 img_box">
  ...
  <div className="detailspart ">
            ...
            <div className="personalInformation text-light d-flex justify-content-between">
  ...
  <div className="container tab_list_box">
      ...
      <div className="tab-content col-12 ">
          ...
          (
            <>
            <div className="container bg-white height_full">
              <div className="message text-center">
              <label htmlFor="
          ">
              page en construction

              <p className='p-3'>sera disponible dans les prochaine version</p>
          </label>
