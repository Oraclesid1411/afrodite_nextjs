         ...
         <header className="sticky-header border-btm-black header-1">
             <div className="header-bottom">
                <div className="container w-100 text_box">
                    <div className="row header_main_container">
                        <div className="first_container col-lg-2 col-md-4 col-4">
                        ...
                        <div className="mobile_main_nav d-lg-none">
                            <nav className="site_mobile_navigation">
                                <ul className="main-menu list-unstyled justify-content-center">
        ...
        >
          <a className="nav-link" href={link.path}>
            {link.name}
                        ...
                        <div className="third_container col-lg-2 col-md-8 col-8">
                ...
                <div className="offcanvas-body p-0 d-flex flex-column justify-content-between">
                    <nav className="site-navigation">
                        ...
                        {current_link === "" ?
                                ...
                                <div className={`submenu-transform submenu-transform-desktop ${activeIndex === 0 ? 'active' : ''}`}>
                                        ...
                                        <div className="offcanvas-header border-btm-black">
                                            <h5 className="drawer-heading btn-menu-back d-flex align-items-center" onClick={() => handleOpenMenu(null)}>
                                                ...
                                                <span className="menu-back-text"> Devenir un modèle et cie</span>
                                            </h5>
                                        </div>
                                        <ul className="submenu list-unstyled">
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="">
                                                            <h6 className="text-center">Devenir un modèle</h6>

                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub drop" href="/postuler/1">mannequin</a>
                                                            </li>

                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub" href="/postuler/2">hotesse d&apos;accueil</a>
                                                            </li>

                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub" href="/postuler/3">influenceur</a>
                                                            </li>
                                                        ...
                                                        <div className="">
                                                            <h6 className="text-center">services afrodites</h6>


                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub" href="/mannequins">se former à poser</a>
                                                            </li>

                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub" href="/influenceur">se former à marcher</a>
                                                            </li>
                                                            

                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub" href="/hodesse_accueil">faire un book</a>
                                                            </li>
                                 ...
                                 <div className="mega-menu-header text-left">
                                    ...
                                    <span className="open-submenu" onClick={() => handleOpenMenu(1)}>
                                                 <svg className="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                                    strokeLinejoin="round">
                                ...
                                <div className={`submenu-transform submenu-transform-desktop ${activeIndex === 1 ? 'active' : ''}`}>
                                        ...
                                        <div className="offcanvas-header border-btm-black">
                                            <h5 className="drawer-heading btn-menu-back d-flex align-items-center" onClick={() => handleOpenMenu(null)}>
                                                ...
                                                <span className="menu-back-text"> Engager un modèle</span>
                                            </h5>
                                        </div>
                                        <ul className="submenu list-unstyled">
                                                        ...
                                                        <div className="">
                                                            ...
                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub drop" href="/mannequins">mannequin</a>
                                                            </li>

                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub" href="/hotesse_accueil">hotesse d&apos;accueil</a>
                                                            </li>

                                                            <li className="menu-list-item nav-item-sub">
                                                                <a className="nav-link-sub nav-text-sub" href="/influenceur">influenceur</a>
                                                            </li>
