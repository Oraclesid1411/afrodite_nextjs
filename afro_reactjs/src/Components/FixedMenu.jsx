...
import { faUser,faAngleUp, faHome, faCalendar, faHeart, faList } from '@fortawesome/free-solid-svg-icons';
...
const FixedMenu = () => {
    ...
    const location = useLocation(); // Utilisation de React Router pour récupérer le chemin actuel

    // Déterminer quel lien est actuellement actif
