...
const ImageModal = ({ image, data, onClose, onDataLoaded }) => {
  ...
  // Handle single click for Fancybox (opens image)
  const handleClick = (e) => {
    // Simple click to allow Fancybox to open the image
    e.preventDefault(); // Prevent any unwanted behavior from the link
  };
        ...
        {imagesWithContributors.map((currentImage, index) => (
          <div key={currentImage.id_image} className="image-section text-center">
            ...
            <a
              ...
              onClick={handleClick}  // Optional click handler if you want to prevent default actions
            >
              <img
                ref={imageRef}
