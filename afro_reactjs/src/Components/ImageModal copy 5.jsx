    ...
    const fetchData = async () => {
      try {
        ...
        if (rep_posts?.data) {
          ...
          // const thisPostId = rep_posts?.data?.post_id;
        ...
        <div className="modal-content"
         >
          <div className="image-section text-center">
            <a className="hover-switch" href={`${apiUrl}/${getPathForResolution_b(currentImage.paths)}`} data-fancybox="gallery">
              <img
