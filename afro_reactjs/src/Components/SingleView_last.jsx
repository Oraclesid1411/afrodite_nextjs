...
const Calendar_view = React.lazy(() => import('../Pages/Calendar_view.jsx'));
...
import {faShare,faCalendar, faUserPlus,faUser, faImage,faFilm ,faList ,faThumbsUp,faHeart,faComment, faInfo} from '@fortawesome/free-solid-svg-icons';
...
// les eventsdu model
  useEffect(() => {
      ...
      try {
        ...
        const [rep1, rep_b, rep_c , rep_d] = await Promise.all([
          ...
          // axios.post(`${apiUrl}/locations/liste_ville`, { id_model })
        ]);
  ...
  const modelData = [
    ...
    { label: 'age', value: '19 ans' },
     ...
     console.log(liste_langue)
     console.log(liste_nationalite)
...
console.log(share_page)
 ...
 useEffect(() => {
  ...
  // const handleLike_page = async (pageId) => {
  //   // alert('test')
  //   console.log("pageId")
  //   console.log(pageId)
...
//   // Vérifier si un hash est présent avant de le supprimer
...
//     window.history.back(); // Revenir en arrière pour restaurer l'état précédent
//   }
