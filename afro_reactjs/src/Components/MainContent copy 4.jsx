      ...
      <main id="MainContent" className="content-for-layout">
        ...
        <Hero/>
            ...
            <div className='col-12 box_container'>
               ...
               <div className="col-9 left_box pt-2">
               ...
               {groupedResults.map((item) => (
                   <div key={item?.id_mannequin}  className='sliderContainer'>
                       <Link  to={`mannequins/${item?.id_mannequin}`}>
                           <img 
               ...
               {groupedResults_b.map((item) => (
                   <div key={item?.model_id}  className='sliderContainer'>
                       <Link  to={`single_viewH/3/${item?.model_id}`}>
                           <img 
                           // src={`${apiUrl}/${item?.path_image}`} 
                           src={`${apiUrl}/${getPathForResolution(item.paths)}`
               ...
               <div className="col-3 right_box pt-2">
                  <div className="col-12 item_box pt-1">
                       <div className=" title_hg center_title fs_gh">
            ...
            {groupedResults_e.map((item) => (
                <div key={item?.idcontributeur} className="sliderContainer">
                    <div className="center_title fs_mh mb-1">
                        photographes
                    </div>
                    <div className="content">
                        <div className=" text-center">
                            <div >
                                <Link to={`singleViewP/1/${item?.model_id}`}>
                                    <img 
                                        // src={`${apiUrl}/${item?.path_image}`} 
                                        src={`${apiUrl}/${getPathForResolution(item.paths)}`}
                                        alt="photographe" 
            ...
            {groupedResults_f.map((item) => (
                <div key={item?.idcontributeur} className="sliderContainer">
                    ...
                    <div className="content">
                        <div className="text-center">
                            <div className="">
                                <Link to={`singleViewP/2/${item?.model_id}`}>
                                    <img 
                                        // src={`${apiUrl}/${item?.path_image}`} 
                                        src={`${apiUrl}/${getPathForResolution(item.paths)}`}
                                        alt="mannequin" 
            ...
            {groupedResults_g.map((item) => (
                <div key={item?.idcontributeur} className="sliderContainer">
                    ...
                    <div className="content">
                        <div className="text-center">
                            <div className="">
                                <Link to={`singleViewP/4/${item?.model_id}`}>
                                    <img 
                                        // src={`${apiUrl}/${item?.path_image}`} 
                                        src={`${apiUrl}/${getPathForResolution(item.paths)}`}
                                        alt="styliste" 
            ...
            {groupedResults_h.map((item) => (
                <div key={item?.idcontributeur} className="sliderContainer">
                    ...
                    <div className="content">
                        <div className="text-center">
                            <div className="">
                                <Link to={`singleViewP/3/${item?.model_id}`}>
                                    <img 
                                        // src={`${apiUrl}/${item?.path_image}`} 
                                        src={`${apiUrl}/${getPathForResolution(item.paths)}`}
                                        alt="coiffeur" 
