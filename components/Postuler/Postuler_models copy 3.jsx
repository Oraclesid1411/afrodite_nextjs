...
// return false;
  ...
  const renderForm = (type) => {
      ...
      case "devenir_vlogueuse":
        ...
        case "se_former":
          return (
                  ...
                  {Object.keys(categories).map((category, index) => (
                    <div key={index} className="category_block">
                           ...
                           (
                            ...
                            (
                             ...
                             (
                              ...
                              (
                                <>rencontrer afrodite pour des conseils</>
                               )
                             :
                      ...
                      {selectedCategories.includes(category) && (
                        <div className="sub_list">
                          {categories[category].map((formation, i) => (
                            <label key={i} className="option_data sub_option">
                              ...
                              (
                                <>
                                Défilé sur podium (techniques de marche, posture)
                                </>
                          ...
                          (
                            <>
                            Poses photo pour shootings professionnels
                            </>
                        ...
                        (
                          <>
                          Gestion de l’expression faciale et du regard
                          </>
                      ...
                      (
                        <>
                        Tenue et élégance sur scène et en studio
                        </>
                    ...
                    (
                      <>
                      Adaptation aux différents styles de mode (casual, haute couture, lingerie, sport, etc.)
                      </>
            ...
            (
              <>
              Gestion du stress en événementiel
              </>
    ...
    (
      <>
      Stratégie de contenu sur Instagram, TikTok, YouTube
      </>
  ...
  (
    <>
    Comment construire une audience et fidéliser les abonnés
    </>
  ...
  (
  <>
  Montage vidéo et retouche photo pour un feed professionnel
  </>
  ...
  (
  <>
  Algorithmes des réseaux sociaux et engagement
  </>
  ...
  (
  <>
  Techniques de maquillage de base et avancé
  </>
  ...
  (
  <>
  Maquillage professionnel pour shootings et défilés
  </>
  ...
  <>
      Soin de la peau et entretien du visage
  </>
  ...
  (
  <>
  Choisir les bons produits selon le type de peau
  </>
  ...
  <>
      Techniques de coiffure simple et stylisme
  </>
  ...
  (
  <>
  Préparer un casting et réussir une audition
  </>
  ...
  (
  <>
  Comment créer un book professionnel
  </>
  ...
  (
  <>
  Exercices de confiance en soi et gestion du stress
  </>
  ...
  (
  <>
  Travail de la voix et de la posture pour la présentation
  </>
  ...
  (
  <>
  Simulation de casting et mise en situation
  </>
  ...
  (
  <>
  Les codes vestimentaires et le dress code selon les événements
  </>
  ...
  (
  <>
  Techniques de networking et gestion de son image publique
  </>
  ...
  (
  <>
  Gérer son attitude et ses interactions avec les clients et médias
  </>
  ...
  (
  <>
  Entraînement physique pour mannequin (tonification, souplesse)
  </>
  ...
  (
  <>
  Nutrition et équilibre alimentaire pour rester en forme
  </>
  ...
  (
  <>
  Exercices pour améliorer la posture et l’endurance
  </>
  ...
  (
  <>
  Yoga et relaxation pour gérer le stress
  </>
     ...
     <div className=" form_bg bg-white">
      ...
      <form autoComplete='off' className='candidature_form'>
        ...
        <div className="bg_box">
           ...
           <div className="lbl_title w-100 my-1">
        vous êtes:
        </div>
