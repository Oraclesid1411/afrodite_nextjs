...
function PostulerMannequin() {
  ...
  const [hostModel, sethostModel] = useState(null);
                      ...
                      <div style={{ border: '1px solid #ccc', marginBottom: '10px' }}>
                              ...
                              <div className="section-header ">
                                <div className="text-center">
                                    <h2 className="text-center">Dévenir Fashion Modele</h2>
                                </div>
                              </div>
                 ...
                 <div className="container mt-3">
                    ...
                    <div className="row">
                      <div style={{ border: '1px solid #ccc', marginBottom: '10px' }}>
                          ...
                          <div className="section-header">
                          <h6 className="mt-3 text-center">Dévenir aussi Host modele</h6>
                        </div>
                                  ...
                                  <input 
                                    ...
                                    <div className="col-12">
                                      <span className="text-danger text-center">
                                        Vous allez aussi postuler pour dévenir Hotesse d'accueil
                                      </span>
                                    </div>
                                  </div>
...
export default PostulerMannequin