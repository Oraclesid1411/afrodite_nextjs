...
{selectedOption_rx === "whatsapp" && (
        <div className="rxsx_chk">
          <input type="checkbox" checked readOnly className="mr-2" />
          <FaWhatsapp className="icon_rxsx text-green-500 ml-2" />
        </div>
      )}
      {selectedOption_rx === "telegram" && (
        <div className="rxsx_chk">
          <input type="checkbox" checked readOnly className="mr-2" />
          <FaTelegram className="icon_rxsx text-blue-500 ml-2" />
        </div>
      )}
      {selectedOption_rx === "signal" && (
         <div className="rxsx_chk">
          <input type="checkbox" checked readOnly className="mr-2" />
          <img src="/assets/img/msg/signal.jpeg" className="brand_icon" alt="Signal" />
        </div>
      )}
      {selectedOption_rx === "viber" && (
         <div className="rxsx_chk">
          <input type="checkbox" checked readOnly className="mr-2" />
          <img src="/assets/img/msg/viber.jpeg" className="brand_icon" alt="Viber" />
        </div>
      )}
      ...
      <button
        className={`dropdown-toggle ${selectedCategories_rx.length > 0 ? "bg-blue-500" : "bg-transparent"}`}
        onClick={handlePlusClick_rx}
      >
        ...
        <div className="dropdown-menu">
          {categoriesList_rx.map((category) => (
            <div key={category.id} className="dropdown-item">
              <label>
                <input type="checkbox"
                  checked={selectedCategories_rx.includes(category.id)}
                  onChange={
                    () => handleCheckboxChange_rx(category.id)
                  }
                />
                {
                   category.label
