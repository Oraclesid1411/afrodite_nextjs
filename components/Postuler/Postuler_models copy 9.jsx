        ...
        vous êtes:
            ...
            <div className="line_data_a">
              ...
              <input 
                 ...
                 className="input_value" type="text"
                 placeholder="nom"
           ...
           />
             ...
             <div className="input_label bis_label">
              <label className="ext_label ">
                taille
              </label>
...
<input type="text" className="indicatif" placeholder="indicatif"
value={phone_ind} onChange={(e) => setPhone_ind(e.target.value)} />

<input type="tel" className="contact" placeholder="numéro"
